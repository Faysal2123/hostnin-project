            ...
            <div
              ...
              className={`relative w-full max-w-sm mx-auto bg-white rounded-2xl shadow-xl flex flex-col transition-all duration-300 border-2 hover:shadow-2xl hover:-translate-y-2 ${
                plan.highlight
                  ...
                  : plan.title === "Basic" || plan.title === "Starter" || plan.title === "Ultimate"
            ...
            >
              ...
              <div className="flex flex-col justify-between px-6 py-6 w-full h-full">
                ...
                <div className="text-center mb-8">
                  ...
                  {plan.savingsText && (
                    <div className="bg-gradient-to-r from-green-50 to-blue-50 text-green-700 font-bold text-sm md:text-sm mb-6 px-4 py-2 rounded-full border border-green-200 inline-block shadow-sm">
                      {plan.savingsText}
                    </div>
                  )}
