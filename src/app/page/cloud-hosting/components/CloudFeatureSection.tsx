    ...
    <div className='bg-[#f8f8f8] py-8 sm:py-12 lg:py-16 pb-12 sm:pb-16 lg:pb-20'>
      ...
      <div className="flex-1 lg:pr-8 xl:pr-16">
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
          <button className="bg-blue-600 hover:bg-blue-700 text-white font-medium px-4 sm:px-6 lg:px-8 py-2 sm:py-3 rounded-lg transition-colors text-sm sm:text-base">
            Sign Up
          </button>
          <button className="text-gray-700 hover:text-blue-500 font-medium px-4 sm:px-6 lg:px-8 py-2 sm:py-3 transition-colors text-sm sm:text-base">
            Compare Pricing
          </button>
        </div>
      </div>
