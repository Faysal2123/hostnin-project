...
const FeatureCards: React.FC = () => {
  return (
    <section className="w-full bg-[#f7f8fa] py-16 flex flex-col items-center relative overflow-x-hidden" style={{ fontFamily: '"Mulish", sans-serif' }}>
      <div className="max-w-7xl w-full mx-auto px-4">
        <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-10 gap-4 md:gap-0">
          <div className="md:w-2/3">
            <h2 className="text-3xl md:text-4xl font-extrabold text-[#03206B] mb-2 leading-tight" style={{ fontFamily: '"Mulish", sans-serif' }}>
              When You Expect Performance<br />Get Hostnin Managed VPS
            </h2>
          </div>
          <div className="md:w-1/3 mt-4 md:mt-0 flex items-center">
            <p className="text-gray-500 text-base md:text-sm font-medium md:text-right" style={{ fontFamily: '"Mulish", sans-serif' }}>
          ...
          {featureCardsData.map((card, idx) => (
            ...
            >
              ...
              <div className="flex flex-col items-center sm:items-start justify-center text-center sm:text-left">
                <span className="font-bold text-lg sm:text-xl text-[#03206B] mb-2" style={{ fontFamily: '"Mulish", sans-serif' }}>
                  {card.title}
                </span>
                <span className="text-gray-500 text-base font-medium" style={{ fontFamily: '"Mulish", sans-serif' }}>
                  {card.description}
                </span>
              </div>
            </div>
