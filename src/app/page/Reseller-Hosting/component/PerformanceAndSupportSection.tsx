      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-16 sm:gap-20 md:gap-24">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 sm:gap-10 md:gap-12">
          ...
          <div className="flex-1 max-w-xl order-2 md:order-1">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#0a174e] mb-3 sm:mb-4">
            ...
            <ul className="mb-6 sm:mb-8 space-y-2 sm:space-y-3">
              {performanceFeatures.map((feature, idx) => (
                <li key={idx} className="flex items-center gap-2 text-xs sm:text-sm text-[#0a174e]">
                  <MdCheckCircle className="text-blue-600" size={16} />
                  <span className='font-semibold'>{feature}</span>
                </li>
              ))}
            </ul>
            <button className="bg-blue-600 hover:bg-blue-700 text-white font-medium px-6 sm:px-8 py-2.5 sm:py-3 rounded-lg transition-colors text-sm sm:text-base">
              See Pricing
            </button>
          </div>
          {/* Image */}
        ...
        {/* Support Section */}
        <div className="flex flex-col md:flex-row-reverse items-center justify-between gap-8 sm:gap-10 md:gap-12">
          {/* Text */}
          ...
          <div className="flex-1 flex justify-center w-full md:w-[500px] order-1">
            <Image
