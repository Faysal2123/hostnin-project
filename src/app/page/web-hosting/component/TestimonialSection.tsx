...
const TestimonialSection = () => (
  <section className="flex flex-col lg:flex-row justify-center items-center gap-6 sm:gap-8 py-8 sm:py-12 px-4 sm:px-6 bg-[#f8f8f8]">
    {/* Left Side */}
    <div className="relative w-full lg:flex-1 max-w-lg flex flex-col items-start">
      ...
      <div className="z-20">
        ...
        <div className="text-gray-700 mb-2 sm:mb-3 md:mb-4 font-medium sm:font-semibold text-sm sm:text-base md:text-lg">
        ...
        <p className="text-gray-500 mb-3 sm:mb-4 md:mb-6 max-w-md text-xs sm:text-sm md:text-base">
        ...
        <div className="flex items-center gap-2 mt-2">
          ...
          <span className="ml-2 sm:ml-4 text-[#2B4EFF] text-xs sm:text-sm md:text-base font-medium cursor-pointer flex items-center">
            <Image
              src={arrowDark}
              alt="Arrow"
              width={24}
          ...
          <div key={idx}>
            <div className="flex items-center mb-1 px-2 sm:px-5">
              ...
              <div className="ml-3 sm:ml-4 flex flex-col">
                <span className="font-bold sm:font-extrabold text-base sm:text-lg md:text-xl text-[#03206B] leading-tight">
                  {testimonial.name}
                </span>
            ...
            <p className="text-gray-600 mt-3 sm:mt-4 mb-6 sm:mb-8 text-xs sm:text-sm md:text-base leading-relaxed max-w-3xl px-2 sm:px-5">
              {testimonial.text}
            </p>
