...
const PricingSection = () => {
  ...
  return (
    <section id="pricing-section" className="pricing-scroll w-full flex flex-col items-center justify-center py-6 sm:py-8 md:py-14 lg:py-20 bg-[#f8f8f8] pt-[600px] sm:pt-[500px] md:pt-[550px] lg:pt-60 px-3 sm:px-6" style={{ fontFamily: '"Plus Jakarta Sans", sans-serif' }}>
            ...
            >
              ...
              <div className="flex flex-col justify-between px-4 sm:px-6 py-4 sm:py-6 w-full h-full">
                ...
                <div className="text-center mb-8">
                  ...
                  {plan.savingsText && (
                    <div className="bg-gradient-to-r from-green-50 to-blue-50 text-green-700 font-bold text-sm md:text-base mb-6 px-4 py-2 rounded-full border border-green-200 inline-block shadow-sm" style={{ fontFamily: '"Plus Jakarta Sans", sans-serif' }}>
                      {plan.savingsText}
                    </div>
                  )}
