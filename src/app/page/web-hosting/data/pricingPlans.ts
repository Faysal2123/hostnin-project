...
const pricingPlans: PricingPlan[] = [
  ...
  },
  {
    ...
    expandedFeatures: {
      general: [
        { text: "Unlimited Subdomains", included: true, tooltip: "Create unlimited subdomains for your main domain" },
        { text: "Unlimited Emails", included: true, tooltip: "Create unlimited email accounts for your domain" },
        { text: "Unlimited Databases", included: true, tooltip: "Create unlimited MySQL databases for your applications" },
        { text: "Genuine Latest Control Panel", included: true, tooltip: "Access to the latest version of cPanel control panel" },
        { text: "CloudLinux Operating System", included: true, tooltip: "Advanced Linux distribution optimized for shared hosting" },
        { text: "LiteSpeed Super Cache", included: true, tooltip: "High-performance caching system for faster website loading" },
        { text: "Softaculous App Installer", included: true, tooltip: "One-click installer for 400+ applications including WordPress" },
        { text: "Free WordPress Toolkit", included: true, tooltip: "Advanced WordPress management and optimization tools" },
      ...
      server: [
        ...
        { text: "Imunify 360 Security", included: true, tooltip: "Advanced security suite for malware protection" },
  ...
  },
  {
    ...
    currency: "৳",
    billingPeriod: "monthly",
    features: createFeatures("20 GB", "Super Fast Website Speed", "10"),
    expandedFeatures: {
      general: [
        { text: "Unlimited Subdomains", included: true, tooltip: "Create unlimited subdomains for your main domain" },
        { text: "Unlimited Emails", included: true, tooltip: "Create unlimited email accounts for your domain" },
  ...
  },
  {
    ...
    currency: "৳",
    billingPeriod: "monthly",
    features: createFeatures("50 GB", "Maximize Website Speed", "Unlimited"),
    expandedFeatures: {
      general: [
        { text: "Unlimited Subdomains", included: true, tooltip: "Create unlimited subdomains for your main domain" },
        { text: "Unlimited Emails", included: true, tooltip: "Create unlimited email accounts for your domain" },
      ...
      server: [
        ...
        { text: "35 MBPS I/O Speed", included: true, tooltip: "Input/Output speed for data transfer" },
