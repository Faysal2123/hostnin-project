...
export const featureBenefits: FeatureBenefit[] = [
  {
    ...
    description: `We provide a popular and widely used control panel for our reseller hosting plans. cPanel is the latest version and is protected by advanced security guidelines. Every day, our experts check the security of the server, and we protect the website in real time so that it can't be hacked. Our control panel comes with all the advanced features built in.`,
    icon: FaCpanel,
  },
  {
  ...
  },
  {
    ...
    description: `A website that loads slowly won't be able to rank on Google, so speed is an important part of SEO. We utilize the LiteSpeed web server to make your website faster than ever because Apache can't handle a website that is too fast for this. Your website will be 40x faster thanks to our LiteSpeed technology.`,
    icon: FaRocket,
  },
  {
    title: 'CloudLinux OS',
  ...
  },
  {
    ...
    description: `PHP Selector is a CloudLinux component that sits on top of CageFS. It allows each user to select a PHP version and module based on their needs. PHP selectors make your clients' websites flexible with any script or CMS. All versions are available from your control panel. From 5.4x to the latest. Sometimes, it has been necessary to update PHP as the script demands it. Directly from the Cpanel, no need to navigate around.`,
    icon: FaPhp,
  },
]; 