...
const ContactSection = ({
  ...
  return (
    <div className='bg-[#fafbfc]'>
      <section className="bg-[#00052E] py-10 xs:py-14 relative overflow-hidden max-w-7xl mx-auto">
      ...
      <div className="container mx-auto px-2 xs:px-4">
        <div className="text-center text-white space-y-2 xs:space-y-4">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-2 xs:gap-4 mt-6 xs:mt-8">
            <Link 
              href="#"
              className="bg-[#0066FF] text-white px-6 xs:px-8 py-2 xs:py-3 rounded-lg hover:bg-blue-600 transition-colors text-sm xs:text-base"
            >
              Live Chat With Sales
            </Link>
            <Link 
              href="tel:01325875955"
              className="flex items-center gap-2 text-white hover:text-blue-300 transition-colors text-sm xs:text-base"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 xs:h-6 w-5 xs:w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
